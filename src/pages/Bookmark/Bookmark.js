...
import {getBookmarkPosts} from "../../actions/bookmark"
...
const Home = ({
  ...
  window.onscroll = async (e) => {
    ...
    if (
      ...
      // setLoading(true)
      const res = await getBookmarkPosts(limit, offset);
...
Home.propTypes = {
  getBookmarkPosts: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getBookmarkPosts })(Home);
